$(document).ready(function() {
    ...
    $('#form').submit(function(event) {
      ...
      approveAndLockTokens(tokenAddress, amount, withdrawer, unlockDateTime);
    });
  
    // Function to approve and lock tokens
    async function approveAndLockTokens(tokenAddress, amount, withdrawer, unlockDateTime) {
      try {
        ...
        // Lock tokens
        await contract.methods.lockTokens(tokenAddress, amount, withdrawer, unlockDateTime).send({ from: userAddress });
